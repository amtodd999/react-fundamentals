...
const useNumHook = (num) => {
    ...
    useEffect(() => {
        ...
        //7.3 useEffect passes a second argument--the 'queryNum' inside the array, so that the callback doing the fetching is only called when there's a change to queryNum
    }, [queryNum])
